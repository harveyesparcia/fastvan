    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (isset($_REQUEST["DriverId"])) {
            ...
            if ($conn->connect_error) {
                ...
                $query = "SELECT * FROM DriversTransactions WHERE DriverId = ?";
            ...
            if ($conn->connect_error) {
                ...
                // Retrieve all data
                $query = "SELECT * FROM DriversTransactions";
        ...
        if ($conn->connect_error) {
            ...
            $updateQuery = "UPDATE DriversTransactions SET ";
            $updateParams = array();
